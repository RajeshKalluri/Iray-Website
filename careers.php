...
<head>
  ...
  .job-card__location, .job-card__date {
    display: flex;
    align-items: center;
    gap: 5px;
    color: #666;
  ...
  .job-card__location i, .job-card__date i {
    color: #0272f6;
    font-size: 1rem;
  }
...
<body>
	...
	<section class="careers pt-70 pb-70">
      <div class="container">
        ...
        <div class="job-listings">
          ...
          <div class="job-card" data-job="sap-mobility">
            <div class="job-card__content">
              <h3 class="job-card__title">SAP Mobility Lead (BTP/Fiori Main)</h3>
              <div class="job-card__meta">
                <div class="job-card__location">
                  <i class="icon-map-marker"></i>
                  <span>Kuwait</span>
          ...
          <div class="job-card" data-job="data-science">
            <div class="job-card__content">
              <h3 class="job-card__title">Principal Analyst - Data Science</h3>
              <div class="job-card__meta">
                <div class="job-card__location">
                  <i class="icon-map-marker"></i>
                  <span>Bangalore</span>
          ...
          <div class="job-card" data-job="senior-analyst">
            <div class="job-card__content">
              <h3 class="job-card__title">Senior Principal Analyst</h3>
              <div class="job-card__meta">
                <div class="job-card__location">
                  <i class="icon-map-marker"></i>
                  <span>Bangalore</span>
  ...
  const jobData = {
    ...
    'sap-mobility': {
      title: 'SAP Mobility Lead (BTP/Fiori Main)',
      location: 'Kuwait',
      type: 'Full Time',
      experience: '12 Years',
      description: 'The Senior SAP Mobility Lead (BTP/Fiori Main) is a highly experienced technical professional with over 12 years of expertise, responsible for overseeing the end-to-end design, development, and implementation of advanced SAP mobile applications and solutions. This role requires a blend of technical prowess, strategic thinking, and effective leadership to ensure the creation of seamless, user-centric, and innovative mobile solutions using the SAP Business Technology Platform (BTP) and Fiori technology stack.',
      responsibilities: [
        'Develop strategic roadmaps for mobile application architecture, incorporating S4, Hana, E2E, and SF considerations.',
        'Recommend cutting-edge SAP technologies to enhance mobile capabilities within the context of S4, Hana, E2E, and SF environments.',
        'Lead and mentor a team of developers, architects, and designers, emphasizing expertise in S4, Hana, E2E, and SF integration.',
        'Make critical design decisions that align with scalability, reliability, and performance objectives across S4, Hana, E2E, and SF landscapes',
        'Define and implement advanced integration approaches (APIs, microservices, hybrid cloud), considering the nuances of S4, Hana, E2E, and SF ecosystems.',
        'Ensure flawless connectivity and data synchronization between mobile applications and S4, Hana, E2E, and SF backend systems.'
      ],
      requirements: [
        '12+ years of experience in SAP mobile development',
        'Extensive experience with SAP BTP and Fiori',
        'Strong leadership and mentoring abilities',
        'Deep understanding of SAP S4, Hana, E2E, and SF',
        'Expertise in API design and microservices architecture',
        'Strong project management skills'
      ],
      emailSubject: 'Application for SAP Mobility Lead',
      emailBody: 'Hi Sir\n\nI am interested in the SAP Mobility Lead position at I-RAY IT SOLUTIONS.\n\nPlease find my profile from attachment.\n\n\n'
    },
    'data-science': {
    ...
    'senior-analyst': {
      ...
      type: 'Full Time',
      experience: '6+ Years',
      description: 'The Senior Principal Analyst will be responsible for driving large multi-environment projects end to end and will act as an individual contributor.',
      responsibilities: [
        'Drive large multi-environment projects end to end',
        'Design and develop reusable classes for ETL code pipelines',
        'Plan and execute projects and guide junior team members',
        'Demonstrate excellent presentation and communication skills',
        'Work with clients, stakeholders, and product owners'
      ],
      requirements: [
        'Strong experience in solutioning and designing data & analytics projects',
        'Strong Data Modelling Skills and Data Warehousing expertise',
        'Hands-on experience with ETL pipeline development',
        '6+ years of Big Data Processing technologies experience',
        '6+ years of Python/Scala/Java & Linux shell scripting',
        'Experience with ETL tools and data warehousing concepts',
        'Cloud platform experience (AWS/GCP/Azure/Snowflake)',
        'Agile/Scrum methodology experience'
      ],
      emailSubject: 'Application for Senior Principal Analyst',
      emailBody: 'Hi Sir\n\nI am interested in the Senior Principal Analyst position at I-RAY IT SOLUTIONS.\n\nPlease find my profile from attachment.\n\n\n'
    },
    'wlan-developer': {
